...
import { AddAdminModal } from '@/components/administrators/add-admin-modal'
  ...
  useEffect(() => {
    const fetchAdministrators = async () => {
      ...
      try {
        ...
        console.log('Raw admin documents:', snapshot.docs.map(doc => ({ id: doc.id, ...doc.data() })))
        const adminsData = snapshot.docs.map(doc => ({
          id: doc.id,
          ...doc.data(),
          createdAt: doc.data().createdAt?.toDate() || new Date()
        })) as Administrator[]
        console.log('Processed admin data:', adminsData)
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem
                          onClick={() => {
                            ...
                            console.log('Edit administrator:', admin.id)
                          }}
                        >
                          Edit
                        </DropdownMenuItem>
                        <DropdownMenuItem
                          ...
                          onClick={() => {
                            ...
                            console.log('Deactivate administrator:', admin.id)
                          }}
                        >
                          Deactivate
                        </DropdownMenuItem>
